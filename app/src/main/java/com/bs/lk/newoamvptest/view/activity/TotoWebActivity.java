...
public class TotoWebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toto_web);
        ...
        webView.loadUrl(BASE_URL_H5_ROOT_CLIENT_V2+"/mcourtoa/moffice/sign/list_daiban.html?token="+ceshi);

//        webView.loadUrl("http://192.168.20.115:8080/mcourtoa/moffice/sign/doffice/clgl/carApply/html/carApply-daiban-add.html?zw="+"1"+"&token="+ceshi);
    ...
    public void onBackPressed() {
        if (webView.canGoBack()){
            if(webView.getUrl().equals(BASE_URL_H5_ROOT_CLIENT_V2+"/mcourtoa/moffice/sign/list_daiban.html?token="+ceshi)){
                super.onBackPressed();
            }else{ webView.goBack();
            }
        }else{
