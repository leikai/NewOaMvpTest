        ...
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    list.add(String.valueOf(demoBean.getDeptname()));
                    list.add(String.valueOf(demoBean.getDaysTime()));
                    list.add(String.valueOf(demoBean.getMissTime()));
                    list.add(String.valueOf(demoBean.getLeaveTime()));
                    list.add(String.valueOf(demoBean.getLateTime()));
                    list.add(String.valueOf(demoBean.getLeaveEarlyTime()));
