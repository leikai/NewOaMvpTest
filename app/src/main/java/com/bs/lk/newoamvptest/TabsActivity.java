...
import static com.bs.lk.newoamvptest.util.IConstant.REVISION_FULL_SIGN;
import static com.bs.lk.newoamvptest.util.IConstant.REVISION_GRID_SIGN;
...
//        mMsgItem.setBadgeItem(badgeItem);
    ...
    private void initEvent() {
        mActionBarView.getBackBtnView().setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void createRootDir() {
        if (android.os.Build.VERSION.SDK_INT < 23 || PackageManager.PERMISSION_GRANTED ==
            ...
            String[] permissions = {android.Manifest.permission
                    .WRITE_EXTERNAL_STORAGE, android.Manifest.permission.READ_EXTERNAL_STORAGE, android.Manifest
