...
import com.bs.lk.newoamvptest.presenter.FileDepositDetailPresenter;
import com.bs.lk.newoamvptest.presenter.FileReverseDetailPresenter;
import com.bs.lk.newoamvptest.presenter.IFileDepositDetailPresenter;
...
public class FileReverseDetailNew1Activity extends AppCompatActivity implements IFileReverseDetailView{

    @BindView(R.id.btn_file_reverse_detail_back)
    Button btnFileReverseDetailBack;
    ...
    IFileReverseDetailPresenter fileDepositDetailPresenter;

    private WeakReference<FileReverseDetailNew1Activity> ref;

    private  FileReverseDetailNew1Activity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_file_reverse_detail_new1);
        if (getSupportActionBar() != null){
            getSupportActionBar().hide();
        }
        ButterKnife.bind(this);
        fileDepositDetailPresenter = new FileReverseDetailPresenter(this); //绑定P层
    ...
    private void setAdapter() {
        ...
        list.setOnRefreshListener(new OnRefreshListener() {//下拉刷新的操作
            ...
            public void onRefresh() {
                ...
                fileDepositDetailPresenter.doFileDetailData(index,user.getOaid());
            }
        });
        ...
        btnFileReverseDetailBack.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onFileReverseDatas(ArrayList<DepositDataListsBean> reverseDataListsBeans) {
        if (reverseDataListsBeans !=null){
            if (reverseDataListsBeans.size() != 0) {
                tvNodata.setVisibility(View.GONE);
            }else{
                tvNodata.setVisibility(View.VISIBLE);
            }
            activity.addItems(reverseDataListsBeans);
            activity.list.refreshComplete(REQUEST_COUNT);

        }else {
            tvNodata.setVisibility(View.VISIBLE);
            tvNodata.setText("获取数据失败，请刷新重试！");
        }
        isRefresh = false;
    }
