...
public class FileDepositDetailModel implements IFileDepositDetailModel {
    private IFileDepositDetailPresenter fileDepositDetailPresenter;

    public FileDepositDetailModel(IFileDepositDetailPresenter fileDepositDetailPresenter) {
        this.fileDepositDetailPresenter = fileDepositDetailPresenter;
    }
    ...
    public void doParamsForDepositDetail(int i, String oaid) {
        ...
        Observer<String> observer = new Observer<String>() {
            ...
            public void onNext(String s) {
                Log.e("获取当前页面待指派列表数据：",""+s);
                fileDepositDetailPresenter.onFileDetailData(s);
            }
