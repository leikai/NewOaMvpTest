 ...
 * @author lk
 */
public class NormalAttendanceActivity extends AppCompatActivity {
    private com.bin.david.form.core.SmartTable<NormalAttendanceDetailsBean> table;
    private List<AttendanceStatisticsBean> list = new ArrayList<>();
    private String jsonstr = "";
    private List<NormalAttendanceDetailsBean> templist;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SHOW_RESPONSE_EMPLOYEE:
                    ...
                    TableData<NormalAttendanceDetailsBean> tableData = new TableData<NormalAttendanceDetailsBean>("正常考勤详情统计表",templist,
                            username,deptname,usertype,start_date,end_date,start_state,end_state
                    );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_attendance);
        if (getSupportActionBar() != null){
            getSupportActionBar().hide();
        }
        table = findViewById(R.id.normal_attendance_table);
        ...
        table.getConfig().setContentCellBackgroundFormat(new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if (cellInfo.row%2 == 0){
                    return ContextCompat.getColor(NormalAttendanceActivity.this,R.color.tableBackground);
                }
                return 0;
            }
        });
    ...
    private void getData() {
        try {
                ...
                String ly_user_id = intent.getStringExtra("ly_user_id");
                ...
                String sql =" SELECT                                              "+
                        ...
                        "   	WHERE                                         "+
                        "   		(                                         "+
                        "   			WORKING_STATE NOT IN ('正常', '休息')   "+
                        "   			OR WORK_STATE NOT IN ('正常', '休息')   "+
                        "   		)                                         "+
                        "   	AND KQ_DATE >= '"+start_date+"'               "+
                        "   	AND KQ_DATE <= '"+end_date+"'                 "+
                        "   	GROUP BY                                      "+
                    ...
                    public void run() {
                        ...
                        if ("SQL查询成功".equals(jsonObject.getString("msg"))){
                            if (!"0".equals(jsonObject.getString("count"))) {
                                ...
                                sb.append("]");
                                List<NormalAttendanceDetailsBean> resps = (List) JSONArray.parseArray(sb.toString(), NormalAttendanceDetailsBean.class);
