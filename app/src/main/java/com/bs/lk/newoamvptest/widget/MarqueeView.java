package com.bs.lk.newoamvptest.widget;
...
public class MarqueeView extends RecyclerView {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case 1://不论是竖直滚动还是水平滚动，都是偏移5个像素
                        ...
                        if (isSlideToBottom(MarqueeView.this)) {
                            MarqueeView.this.scrollToPosition(0);
                        }
                        break;
                }
            }
    ...
    public static boolean isSlideToBottom(MarqueeView recyclerView) {
