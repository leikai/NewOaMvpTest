...
import com.bs.lk.newoamvptest.presenter.FileReversedDataPresenter;
...
public class FileReverseDataActivity extends AppCompatActivity implements IFileReversedDataView{
    ...
    IFileReversedDataPresenter fileReversedDataRresenter;

    private WeakReference<FileReverseDataActivity> ref;

    private FileReverseDataActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_file_reverse_data);
        if (getSupportActionBar() != null){
            getSupportActionBar().hide();
        }
        ButterKnife.bind(this);
        fileReversedDataRresenter = new FileReversedDataPresenter(this);//绑定P层
    ...
    private void setAdapter() {
        ...
        list.setOnRefreshListener(new OnRefreshListener() {//下拉刷新的操作
            ...
            public void onRefresh() {
                ...
                fileReversedDataRresenter.doFileDetailData(index,user.getOaid());
            }
        });
    ...
    @Override
    public void onReversedDatas(ArrayList<DepositDataListsBean> reversedDataListsBeans) {
        if (reversedDataListsBeans.size() != 0) {
            tvNodata.setVisibility(View.GONE);
        }else{
            tvNodata.setVisibility(View.VISIBLE);
        }
        activity.addItems(reversedDataListsBeans);
