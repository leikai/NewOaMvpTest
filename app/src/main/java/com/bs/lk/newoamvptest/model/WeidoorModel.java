...
public class WeidoorModel implements IWeidoorModel {
    private IWeidoorPresenter weidoorPresenter;

    public WeidoorModel(IWeidoorPresenter weidoorPresenter) {
        this.weidoorPresenter = weidoorPresenter;
    }
    ...
    public void doParamsForWeiPWithText(String json) {
        ...
        Observer<String> observer = new Observer<String>() {
            ...
            public void onNext(String s) {
                Log.e("获取新闻模块的Json数据：",""+s);
                weidoorPresenter.onResultToM(s);
            }
    ...
    public void doParamsForWeiPWithImage(String json) {
        ...
        Observer<String> observer = new Observer<String>() {
            ...
            public void onNext(String s) {
                Log.e("获取新闻模块的图片数据：",""+s);
                weidoorPresenter.onResultToMWithIV(s);
            }
        ...
        Observable<String> observable = Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public void subscribe(ObservableEmitter<String> emitter) throws Exception {
                ...
                //.............
                //执行完毕，触发回调，通知观察者（可以设置观察者的线程）
                String rstJsonForIV  =  WebServiceUtil.getInstance().getWebImgs(json);
                emitter.onNext(rstJsonForIV);
